  ...
  const handleLocationUpdate = useCallback((location) => {
    ...
    if (followUserRef.current) {
      ...
      if (location.heading !== null && location.heading !== undefined) {
        ...
        dynamicCameraOpts.pitch = 60
        dynamicCameraOpts.zoom = 18.2
      }
    ...
    <div className="sjec-root">
      ...
      <div className="sjec-header">
        ...
        <div className="sjec-search-wrap">
          <span className="sjec-search-icon">
        ...
        <button className="sjec-btn" onClick={cycleViewMode}>
          <span>
            {viewMode === '3d' ? (
              ...
              <Satellite size={16} strokeWidth={2.1} />
            ) : (
      ...
      {selectedNode && !routeMode && (
        <div className="sjec-panel">
          <button className="sjec-close" onClick={() => setSelectedNode(null)}>
          ...
          <div className="sjec-info-header">
            ...
            >
              {TYPE_CONFIG[selectedNode.type]?.icon && (() => {
                const Icon = TYPE_CONFIG[selectedNode.type].icon
                return <Icon size={18} strokeWidth={2.1} color={TYPE_CONFIG[selectedNode.type]?.color} />
              })()}
            </div>
            <div>
        ...
        <div className="sjec-panel">
          ...
          {liveTracking && nearestNode && (
            ...
            >
              ...
              Auto-detected: {nearestNode.label}
            </div>
          )}
      ...
      {!mapLoaded && (
        <div className="sjec-loading">
          <div className="sjec-loading-logo">
            <LoaderCircle size={24} strokeWidth={2.2} className="spin" />
          </div>
